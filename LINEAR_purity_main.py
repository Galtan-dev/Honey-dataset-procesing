...
print('Model Accuracy Train :', r2_score(y_train,y_pred_train)*100,'%') # no use
print('Model Accuracy Test  :', r2_score(y_test,y_pred_test)*100,'%') # no use
print("Mean Squared Error:", mean_squared_error(y_test, predictions))
print("Mean Absolute Error:", mean_absolute_error(y_test, predictions))
print("R2 Score:", r2_score(y_test, predictions)) # no use
